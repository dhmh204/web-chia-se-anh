...
const itemAfterCss = `relative overflow-hidden rounded-[24px] border border-[var(--line)] bg-[rgba(8,13,12,0.72)] p-[22px] 
                    ...
                    after:rounded-full after:bg-[rgba(16,185,129,0.12)] after:blur-[32px]`;
...
const StatCard = ({
  ...
  return (
    <div
      className={`p-[20px] relative overflow-hidden ${className} ${itemAfterCss}`}
    >
      <p className="text-[var(--muted)] text-[13px]">{label}</p>
      <h2 className="font-semibold text-[var(--green-2)] text-[25px] letter-spacing-[-.04em] vertical-align: inherit;">
        {value}
      </h2>
